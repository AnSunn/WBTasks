...
// to launch  go run task.go -r -p -D http://example.com
/*
=== Утилита wget ===
Реализовать утилиту wget с возможностью скачивать сайты целиком.
*/
//copy from github.com/MikhailSolovev
type WebPage struct {
	uraw   string
	host   string
	scheme string
...
// Use wget [-flags] url, as example:  go run task.go -r -p -D http://example.com
func main() {
	...
	// проверка принадлежности ссылок изначальному хосту
